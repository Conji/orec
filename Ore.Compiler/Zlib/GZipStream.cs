...
namespace Ore.Compiler.Zlib
{
    ...
    public class GZipStream : Stream
    {
        ...
        virtual public long TotalIn => this.BaseStream.Z.TotalBytesIn;

        /// <summary> Returns the total number of bytes output so far.</summary>
        virtual public long TotalOut => this.BaseStream.Z.TotalBytesOut;
        ...
        public override long Position
        {
            get
            {
                if (this.BaseStream._streamMode == ZlibBaseStream.StreamMode.Writer)
                    return this.BaseStream.Z.TotalBytesOut + _headerByteCount;
